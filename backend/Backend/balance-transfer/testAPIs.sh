...
curl -s -X POST \
  ...
  -H "content-type: application/json" \
  -d '{
	"configUpdatePath":"../artifacts/channel/Org1AnchorPeer.tx"
}'
echo
echo
...
curl -s -X POST \
  ...
  -H "content-type: application/json" \
  -d '{
	"configUpdatePath":"../artifacts/channel/Org2AnchorPeer.tx"
}'
echo
echo
...
curl -s -X POST \
  ...
  -H "content-type: application/json" \
  -d '{
	"configUpdatePath":"../artifacts/channel/Org3AnchorPeer.tx"
}'
echo
echo
...
curl -s -X POST \
  ...
  -d "{
	...
	\"chaincodeVersion\":\"v0\",
	\"chaincodeType\": \"$LANGUAGE\",
	\"args\":[\"Awesome Group\",\"Awesome Steels\",\"Awesome Motors\"]
}"
echo
echo
...
VALUES=$(curl -s -X POST \
  ...
  -H "authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjE1NzYwNDM3ODksInVzZXJuYW1lIjoiSmltIiwib3JnTmFtZSI6Ik9yZzEiLCJpYXQiOjE1NzYwMDc3ODl9.hN6fss4RrddBwY_kEyzfE4ox-CIYCCI3VuGZRCnAfys" \
  -H "content-type: application/json" \
  -d "{
  \"peers\": [\"peer0.org1.example.com\",\"peer0.org2.example.com\",\"peer0.org3.example.com\"],
  \"fcn\":\"newPolicy\",
  \"args\":[\"1000\",\"10/12/2019\",\"12/12/2019\"]
}")
# echo $VALUES
...
# # calculate risc factor
# echo "calculateRiscFactor"
# echo
# VALUES=$(curl -s -X POST \
#   http://localhost:4000/channels/mychannel/chaincodes/mycc \
#   -H "authorization: Bearer $ORG1_TOKEN" \
...
# # echo
#  curl -s -X GET \
#   "http://localhost:4000/channels/mychannel/chaincodes/mycc?peer=peer0.org1.example.com&fcn=query&args=%5B%22policy1%22%5D" \
#   -H "authorization: Bearer $ORG1_TOKEN" \
#   -H "content-type: application/json"
# # echo
# echo
