...
func (t *SimpleChaincode) Init(stub shim.ChaincodeStubInterface) pb.Response  {
	...
	ChildId1 := "Child-1"
	var child1 = Child{ObjectType:"Child", Id: ChildId1, Companyname: args[1]+"_1",PolicyTokens: "0", Tokens: "0", RiskFactor: "6", ClaimToken: "0" }
	...
	ChildId2 := "Child-2"
	var child2 = Child{ObjectType:"Child", Id: ChildId2, Companyname: args[2]+"_2", Tokens: "0", RiskFactor: "7", ClaimToken: "0" }
...
func (t *SimpleChaincode) newPolicy(stub shim.ChaincodeStubInterface, args []string) pb.Response {
	...
	var policy = Policy{ObjectType:"policy", Id: "policy1", TotalTokens: args[0], TotalRisk: "0", CreatedAt: args[1], Deadline: args[2]}
